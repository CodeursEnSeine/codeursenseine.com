      ...
      <Stack spacing="16">
          ...
          >
            <Box maxW="60ch">
              ...
              <Text mb="5">
                ...
                <strong>Kindarena&nbsp;de&nbsp;Rouen</strong>, avec cette année
                un peu d&apos;avance. Nous vous donnons rendez vous le{' '}
        ...
        <Stack spacing={4}>
          ...
          <Text>
            ...
            aux thèmes divers et variés : Web, Devops, UX, Securité, Langages
            etc.
          </Text>
        </Stack>
